...
In these exercises, you will explore spotify songs! 

Please write up your project using R Markdown and `knitr`. Please **show all your code** for each of the answers to each part.
